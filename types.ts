...
export type PostData<T extends MELCloudDevice> = DeviceData & { readonly HasPendingCommand: true } & UpdateData<T>

interface DeviceData {
  readonly DeviceID: number
}

export type UpdateData<T extends MELCloudDevice> = SetDeviceData<T> & { readonly EffectiveFlags: number }
...
export type Capabilities<T extends MELCloudDevice> = SetCapabilities<T> | ReportCapabilities<T> | GetCapabilities<T>
...
type GetCapabilities<T extends MELCloudDevice> = T extends MELCloudDeviceAtw
  ? GetCapabilitiesAtw
  : GetCapabilitiesAta
