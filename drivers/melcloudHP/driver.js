...
class MELCloudHPDriver extends Homey.Driver {
  async onInit () {
    ...
    this.operationModeZoneTrigger = this.homey.flow
      ...
      .registerRunListener(
        (args) =>
          args.mode_hpz1_action ===
          args.device.getCapabilityValue('operation_mode_zone')
      )
    ...
    this.forcedHotWaterTrigger = this.homey.flow
      ...
      .registerRunListener(
        (args) =>
          args.forced_hot_water_trigger ===
          args.device.getCapabilityValue('forced_hot_water')
      )
    ...
    this.homey.flow
      ...
      .registerRunListener(
        (args) =>
          args.forced_hot_water_condition ===
          args.device.getCapabilityValue('forced_hot_water')
      )
    ...
    this.homey.flow
      ...
      .registerRunListener(
        (args) =>
          args.hot_water_value <=
          args.device.getCapabilityValue('flow_temperature')
      )
    ...
    this.homey.flow
      ...
      .registerRunListener(
        (args) =>
          args.cold_water_value >=
          args.device.getCapabilityValue('return_temperature')
      )

    this.homey.flow
      .getConditionCard('alarm_DefrostMode_Condition')
      .registerRunListener((args) =>
        args.device.getCapabilityValue('defrost_mode')
      )

    this.homey.flow
      .getConditionCard('alarm_BoosterHeater1_Condition')
      .registerRunListener((args) =>
        args.device.getCapabilityValue('booster_heater1')
      )

    this.homey.flow
      .getConditionCard('alarm_BoosterHeater2_Condition')
      .registerRunListener((args) =>
        args.device.getCapabilityValue('booster_heater2')
      )

    this.homey.flow
      .getConditionCard('alarm_BoosterHeater2Plus_Condition')
      .registerRunListener((args) =>
        args.device.getCapabilityValue('booster_heater2_plus')
      )

    this.homey.flow
      .getConditionCard('alarm_ImmersionHeater_Condition')
      .registerRunListener((args) =>
        args.device.getCapabilityValue('immersion_heater')
      )
    ...
    this.homey.flow
      ...
      .registerRunListener(async (args) => {
        await args.device.onCapabilityForcedHotWater(
          args.forced_hot_water_action
        )
      })
    ...
    this.homey.flow
      ...
      .registerRunListener(async (args) => {
        await args.device.setSettings({
          cool_flow_temperature: args.cool_water_value
        })
    ...
    this.homey.flow
      ...
      .registerRunListener(async (args) => {
        await args.device.setSettings({
          heat_flow_temperature: args.heat_water_value
        })
        await args.device.syncDeviceFromData()
      })
    ...
    this.homey.flow
      ...
      .registerRunListener(async (args) => {
        await args.device.setSettings({
          set_watertank_temperature: args.tank_water_value
        })
        await args.device.syncDeviceFromData()
      })
  }
  ...
  triggerOperationMode (device) {
    this.operationModeTrigger
      ...
      .then(
        this.log(
          `\`${device.getName()}\`: \`operation_mode_state\` has changed to \`${device.getCapabilityValue(
      ...
      .catch((error) =>
        this.error(
          `\`${device.getName()}\`: \`operation_mode_state\` has not been triggered (${error})`
        )
      )
  }
  ...
  triggerOperationModeZone (device) {
    this.operationModeZoneTrigger
      ...
      .then(
        this.log(
          `\`${device.getName()}\`: \`operation_mode_zone\` has changed to \`${device.getCapabilityValue(
            'operation_mode_zone'
          )}\``
        )
      )
      .catch((error) =>
        this.error(
          `\`${device.getName()}\`: \`operation_mode_zone\` has not been triggered (${error})`
        )
      )
  }
  ...
  triggerFlowTemperature (device) {
    this.flowTemperatureTrigger
      ...
      .then(
        this.log(
          `\`${device.getName()}\`: \`flow_temperature\` has changed to \`${device.getCapabilityValue(
            'flow_temperature'
          )}\``
        )
      )
      .catch((error) =>
        this.error(
          `\`${device.getName()}\`: \`flow_temperature\` has not been triggered (${error})`
        )
      )
  }
  ...
  triggerReturnTemperature (device) {
    this.returnTemperatureTrigger
      ...
      .then(
        this.log(
          `\`${device.getName()}\`: \`return_temperature\` has changed to \`${device.getCapabilityValue(
            'return_temperature'
          )}\``
        )
      )
      .catch((error) =>
        this.error(
          `\`${device.getName()}\`: \`return_temperature\` has not been triggered (${error})`
        )
      )
  }
  ...
  triggerForcedHotWater (device) {
    this.forcedHotWaterTrigger
      ...
      .then(
        this.log(
          `\`${device.getName()}\`: \`forced_hot_water\` has changed to \`${device.getCapabilityValue(
            'forced_hot_water'
          )}\``
        )
      )
      .catch((error) =>
        this.error(
          `\`${device.getName()}\`: \`forced_hot_water\` has not been triggered (${error})`
        )
      )
  }
