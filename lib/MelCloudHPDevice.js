...
class MelCloudDevice extends Homey.Device {
    ...
    getdevicedata(data, callback){
        ...
        http.get(askdevice).then(function (result) {
            ...
            if (result.data) {
                if (result.data.SetHeatFlowTemperatureZone1 < 10){
                    device.setCapabilityValue("hot_temperature", 10)   
                }else if (result.data.SetHeatFlowTemperatureZone1 > 100) {
                    device.setCapabilityValue("hot_temperature", 100)
                } else { 
                    device.setCapabilityValue("hot_temperature", result.data.SetHeatFlowTemperatureZone1)
                }

                if (result.data.SetCoolFlowTemperatureZone1 < 10){
                    device.setCapabilityValue("cold_temperature", 10)   
                }else if (result.data.SetCoolFlowTemperatureZone1 > 100) {
                    device.setCapabilityValue("cold_temperature", 100) 
                } else {
                    device.setCapabilityValue("cold_temperature", result.data.SetCoolFlowTemperatureZone1)
                }
