...
class MelCloudDevice extends Homey.Device {
    ...
    getdevicedata(data, callback){
        ...
        http.get(askdevice).then(function (result) {
            ...
            if (result.data) {
                ...
                console.log ("operation1", result.data.OperationModeZone1)
                ...
                console.log(forcedold, " old / new ", result.data.ForcedHotWaterMode)
    ...
    async updateCapabilityValues(capability, value) {
        try {
            ...
            this._syncTimeout = setTimeout(this.getdevicedata.bind(this), (0.2*60*1000));
